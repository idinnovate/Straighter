...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  readonly IRONFOX_NAME='Straighter'
else
  readonly IRONFOX_CHANNEL='nightly'
  readonly IRONFOX_CHANNEL_PRETTY='Nightly'
  readonly IRONFOX_NAME='Straighter Nightly'
fi
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_ARM64_DEFAULT="${IRONFOX_OUTPUTS_APK}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-${IRONFOX_OUTPUTS_ARM64_SUFFIX}.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_ARM64_UNSIGNED_DEFAULT="${IRONFOX_OUTPUTS_APK_UNSIGNED}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-arm64-v8a-unsigned.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_ARM_DEFAULT="${IRONFOX_OUTPUTS_APK}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-${IRONFOX_OUTPUTS_ARM_SUFFIX}.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_ARM_UNSIGNED_DEFAULT="${IRONFOX_OUTPUTS_APK_UNSIGNED}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-armeabi-v7a-unsigned.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_X86_64_DEFAULT="${IRONFOX_OUTPUTS_APK}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-${IRONFOX_OUTPUTS_X86_64_SUFFIX}.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_X86_64_UNSIGNED_DEFAULT="${IRONFOX_OUTPUTS_APK_UNSIGNED}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-x86_64-unsigned.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_UNIVERSAL_DEFAULT="${IRONFOX_OUTPUTS_APK}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-${IRONFOX_OUTPUTS_UNIVERSAL_SUFFIX}.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_UNIVERSAL_UNSIGNED_DEFAULT="${IRONFOX_OUTPUTS_APK_UNSIGNED}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}-universal-unsigned.apk"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_BUNDLE_AAB_DEFAULT="${IRONFOX_OUTPUTS_AAB}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}.aab"
  else
...
if [[ "${IRONFOX_RELEASE}" == 1 ]]; then
  ...
  if [[ "${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}" != "null" ]]; then
    readonly IRONFOX_OUTPUTS_BUNDLE_DEFAULT="${IRONFOX_OUTPUTS_APKS}/ironfox-${IRONFOX_CHANNEL}-${IRONFOX_VERSION}.${IRONFOX_NIGHTLY_TIMESTAMP_OVERRIDE}.apks"
  else
