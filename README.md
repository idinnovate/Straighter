...
`gecko-configure-ublock-origin.patch`, `gecko-devtools-bypass.patch`, `gecko-fix-rfphelper-import.patch`, `gecko-prevent-exposing-name-and-vendor-to-extensions.patch`, and `gecko-rs-blocker.patch` are adapted from [LibreWolf](https://librewolf.net/). See [LibreWolf License and Disclaimers](https://librewolf.net/license-disclaimers/).
